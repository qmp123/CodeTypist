...
const cors = require("cors"); // cors: CORS 미들웨어
...
// enableCors: 프론트 개발 서버에서의 API 호출 허용
app.use(
  cors({
    origin: ["http://localhost:5173", "http://localhost:3000"], // allowedOrigins: 허용 오리진 목록
    methods: ["GET", "POST"], // allowedMethods: 허용 메서드 목록
  })
);
